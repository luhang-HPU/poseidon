...
public:
    ...
    BMEnv(const poseidon::ParametersLiteralDefault &parms) : parms_(parms), context_(parms_, false)
    {
        ...
        galois_elts_all_.emplace_back(2 * static_cast<uint32_t>(parms_.degree()) - 1);
