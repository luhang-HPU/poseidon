...
namespace util
{
inline void increment_uint_mod(const std::uint64_t *operand, const std::uint64_t *modulus,
...
inline void decrement_uint_mod(const std::uint64_t *operand, const std::uint64_t *modulus,
                               std::size_t uint64_count, std::uint64_t *result)
{
#ifdef POSEIDON_DEBUG
    if (!operand)
...
inline void negate_uint_mod(const std::uint64_t *operand, const std::uint64_t *modulus,
                            std::size_t uint64_count, std::uint64_t *result)
{
#ifdef POSEIDON_DEBUG
    if (!operand)
...
inline void div2_uint_mod(const std::uint64_t *operand, const std::uint64_t *modulus,
                          std::size_t uint64_count, std::uint64_t *result)
{
#ifdef POSEIDON_DEBUG
    if (!operand)
...
inline void add_uint_uint_mod(const std::uint64_t *operand1, const std::uint64_t *operand2,
...
inline void sub_uint_uint_mod(const std::uint64_t *operand1, const std::uint64_t *operand2,
                              const std::uint64_t *modulus, std::size_t uint64_count,
                              std::uint64_t *result)
{
#ifdef POSEIDON_DEBUG
...
bool try_invert_uint_mod(const std::uint64_t *operand, const std::uint64_t *modulus,
