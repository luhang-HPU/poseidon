...
public:
    ...
    POSEIDON_NODISCARD inline const poseidon_byte *data() const noexcept
    {
        return reinterpret_cast<const poseidon_byte *>(buf_.cbegin());
    }

    POSEIDON_NODISCARD inline poseidon_byte *data() noexcept
    {
        return reinterpret_cast<poseidon_byte *>(buf_.begin());
    }

    POSEIDON_NODISCARD inline std::size_t size() noexcept { return buf_.size(); }

    POSEIDON_NODISCARD inline std::size_t capacity() noexcept { return buf_.capacity(); }
...
public:
    ...
    POSEIDON_NODISCARD inline bool at_end() const noexcept { return head_ == end_; }
