...
public:
    ...
    */
    POSEIDON_NODISCARD inline std::size_t size() const noexcept
    {
    ...
    */
    POSEIDON_NODISCARD inline auto &data() noexcept { return keys_; }

    /**
    Returns a const reference to the KSwitchKeys data.
    */
    POSEIDON_NODISCARD inline auto &data() const noexcept { return keys_; }
    ...
    */
    POSEIDON_NODISCARD inline auto &data(std::size_t index)
    {
    ...
    @throws std::invalid_argument if the key at the given index does not exist
    */
    POSEIDON_NODISCARD inline const auto &data(std::size_t index) const
    {
        if (index >= keys_.size() || keys_[index].empty())
        {
            throw std::invalid_argument("keyswitching key does not exist");
    ...
    */
    POSEIDON_NODISCARD inline auto &parms_id() noexcept { return parms_id_; }
    ...
    @see EncryptionParameters for more information about parms_id.
    */
    POSEIDON_NODISCARD inline auto &parms_id() const noexcept { return parms_id_; }
    ...
    */
    ...
    save_size(compr_mode_type compr_mode = Serialization::compr_mode_default) const
    {
        ...
        std::size_t members_size =
            Serialization::ComprSizeEstimate(util::add_safe(sizeof(parms_id_),
    ...
    */
                               ...
                               compr_mode_type compr_mode = Serialization::compr_mode_default) const
    {
        ...
        return Serialization::Save(std::bind(&KSwitchKeys::save_members, this, _1),
    ...
    */
    ...
    {
        using namespace std::placeholders;
        return Serialization::Load(std::bind(&KSwitchKeys::load_members, this, context, _1, _2),
                                   stream, false);
    }

    /**
    Loads a KSwitchKeys from an input stream overwriting the current KSwitchKeys.
    The loaded KSwitchKeys is verified to be valid for the given PoseidonContext.
    ...
    */
    ...
    {
        using namespace std::placeholders;
        return Serialization::Load(std::bind(&KSwitchKeys::load_members, this, context, _1, _2), in,
                                   size, false);
    }
