...
requires a PoseidonContext with valid encryption parameters, and the secret key.
...
public:
    ...
    */
    POSEIDON_NODISCARD int invariant_noise_budget(const Ciphertext &encrypted);
...
private:
    ...
    void dot_product_ct_sk_array(const Ciphertext &encrypted, util::RNSIter destination,
