...
public:
    ...
    */
    POSEIDON_NODISCARD inline result_type operator()() { return generator_->generate(); }

    /**
    Returns the backing UniformRandomGenerator.
    */
    POSEIDON_NODISCARD inline auto generator() const noexcept { return generator_; }

    /**
    Returns the smallest possible output value.
    */
    POSEIDON_NODISCARD inline static constexpr result_type min() noexcept
    {
    ...
    */
    POSEIDON_NODISCARD static constexpr result_type max() noexcept
    {
