...
namespace util
{
POSEIDON_NODISCARD inline std::string poly_to_hex_string(const std::uint64_t *value,
...
POSEIDON_NODISCARD inline std::string poly_to_dec_string(const std::uint64_t *value,
                                                         std::size_t coeff_count,
                                                         std::size_t coeff_uint64_count,
                                                         MemoryPool &pool)
{
...
POSEIDON_NODISCARD inline auto allocate_poly(std::size_t coeff_count,
                                             std::size_t coeff_uint64_count, MemoryPool &pool)
{
    return allocate_uint(util::mul_safe(coeff_count, coeff_uint64_count), pool);
}

inline void set_zero_poly(std::size_t coeff_count, std::size_t coeff_uint64_count,
                          std::uint64_t *result)
{
#ifdef POSEIDON_DEBUG
...
POSEIDON_NODISCARD inline auto allocate_zero_poly(std::size_t coeff_count,
                                                  std::size_t coeff_uint64_count, MemoryPool &pool)
{
    return allocate_zero_uint(util::mul_safe(coeff_count, coeff_uint64_count), pool);
}

POSEIDON_NODISCARD inline auto allocate_poly_array(std::size_t poly_count, std::size_t coeff_count,
                                                   std::size_t coeff_uint64_count, MemoryPool &pool)
{
    return allocate_uint(util::mul_safe(poly_count, coeff_count, coeff_uint64_count), pool);
}

inline void set_zero_poly_array(std::size_t poly_count, std::size_t coeff_count,
...
POSEIDON_NODISCARD inline auto allocate_zero_poly_array(std::size_t poly_count,
                                                        std::size_t coeff_count,
                                                        std::size_t coeff_uint64_count,
                                                        MemoryPool &pool)
{
...
inline void set_poly(const std::uint64_t *poly, std::size_t coeff_count,
                     std::size_t coeff_uint64_count, std::uint64_t *result)
{
#ifdef POSEIDON_DEBUG
...
inline void set_poly_array(const std::uint64_t *poly, std::size_t poly_count,
