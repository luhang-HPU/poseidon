...
of PoseidonContext such that its associated EncryptionParameterQualifiers object has the
...
public:
    ...
    given through the PoseidonContext object support batching.
    ...
    */
    POSEIDON_NODISCARD inline auto slot_count() const noexcept { return slots_; }

    POSEIDON_NODISCARD inline const PoseidonContext &context() const noexcept { return context_; }
...
private:
    ...
    void populate_roots_of_unity_vector(const CrtContext &crt_context);
