...
int main() {
  ...
  print_internal_omp_stage_report("manual-parallel 24-branch evaluation");
  ...
  std::cout << "CKKS DAG manual-parallel 24-branch evaluation TIME: "
            << evaluation_ms << " ms" << std::endl;
  print_stage_cores("CKKS DAG manual-parallel 24-branch evaluation",
                    evaluation_cores);
