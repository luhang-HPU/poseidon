...
int main()
{
    ...
    std::cout << std::endl;
    std::cout << std::fixed << setprecision(2) << "Sigmoid Average Time on CPU: " << (double)sigmoid_time / times << " us" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "Multiply and Relinearize Average Time on CPU: " << multiply_relin_time / times / 1.0 << " us"
              << std::endl;
    std::cout << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "Rotate Average Time on CPU: " << rotate_time / times / 1.0 << " us" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "KSwitch Average Time on CPU: " << kswitch_time / times / 1.0 << " us" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << std::endl;
    std::cout << std::fixed << setprecision(2) << "Conv Average Time on CPU: " << (double)conv_time / times << " us" << std::endl;
    std::cout << std::endl;
